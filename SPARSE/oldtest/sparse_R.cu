// sparse-matrix at right
// $ nvcc -o sparse_R sparse_R.cu -lcusparseLt && ./sparse_R
// $ nsys profile --trace=cuda,nvtx,cublas,cudnn --cuda-memory-usage=true --stats=true --force-overwrite true --output=detail_res_sparse_R ./sparse_R
...
int main(void) {
    ...
    for (int dim : dimensions) {
        ...
        // opA/B = TT, and orderA/B = RC, failed
        ...
        /* opA/B = NN, and orderA/B = CR, also failed
