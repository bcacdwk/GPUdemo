// 编译命令:
// $ nvcc -o sparse sparse.cu -lcusparseLt && ./sparse
// $ nsys profile --trace=cuda,nvtx,cublas,cudnn --cuda-memory-usage=true --stats=true --force-overwrite true --output=nsys_t2sp ./sparse
