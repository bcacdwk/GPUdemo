...
编译运行:
nvcc -o alg_weight_compat_NT_RR_R alg_weight_compat_NT_RR_R.cu -lcusparseLt && ./alg_weight_compat_NT_RR_R
*/
...
int main() {
    ...
    std::string baseDir = "alg_weight_compat_matrix_NT_RR_R";
