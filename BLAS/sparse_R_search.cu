// 稀疏在右
// $ nvcc -o sparse_R_search sparse_R_search.cu -lcusparseLt && ./sparse_R_search
// $ nsys profile --trace=cuda,nvtx,cublas,cudnn --cuda-memory-usage=true --stats=true --force-overwrite true --output=detail_res_sparse_R_search ./sparse_R_search
