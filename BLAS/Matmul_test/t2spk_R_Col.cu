// 稀疏在右，列主序T/N，优化算法
// $ nvcc -o t2spk_R_Col t2spk_R_Col.cu -lcusparseLt && ./t2spk_R_Col
// $ nsys profile --trace=cuda,nvtx,cublas,cudnn --cuda-memory-usage=true --stats=true --force-overwrite true --output=detail_res_t2spk_R_Col ./t2spk_R_Col
