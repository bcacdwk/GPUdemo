// 稀疏在右
// $ nvcc -o t2spk_R t2spk_R.cu -lcusparseLt && ./t2spk_R
// $ nsys profile --trace=cuda,nvtx,cublas,cudnn --cuda-memory-usage=true --stats=true --force-overwrite true --output=detail_res_t2spk_R ./t2spk_R
