// 稀疏在左，列主序T/N，不优化算法
// $ nvcc -o t2spk_L_Col_noAlg t2spk_L_Col_noAlg.cu -lcusparseLt && ./t2spk_L_Col_noAlg
// $ nsys profile --trace=cuda,nvtx,cublas,cudnn --cuda-memory-usage=true --stats=true --force-overwrite true --output=detail_res_t2spk_L_Col_noAlg ./t2spk_L_Col_noAlg
